...
def main(argv):
   ...
   WriteAsset(outputfile, board, cpuSpawns, playerSpawns)
	...
	for x in range(width):
		for y in range(height):
			...
			if (r,g,b)==playerSpawn:
				playerSpawns.append((x,y,random.randint(0,len(heightmap))))
			elif (r,g,b)==cpuSpawn:
				cpuSpawns.append((x,y,random.randint(0,len(heightmap))))
...
def WriteAsset(outputfile, board, cpuSpawns, playerSpawns):
